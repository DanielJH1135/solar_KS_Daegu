...
// ==========================================
// 2. 상가·원룸 자가용(RPS) 전용 데이터 부하
// ==========================================
const rpsTargets = ["** 건물주님", "원룸 소유주님", "** 상가 사장님", "** 빌딩 대표님", "옥상 소유주님", "** 상가주택 사장님", "건물 관리인님","**빌딩 관리단 대표님"];
const rpsSuffixes = [
  "방금 전 타사 비교견적 검토 요청 완료!",
  "2분 전 옥상 맞춤형 첫 견적 문의 완료!",
  "3분 전 상가 전기세 절감 가견적 신청!",
  "방금 전 직영 단가 비교 접수!",
  "1분 전 원룸 공용 관리비 진단 요청!",
  "실시간 직영 단가 비교 신청 완료!",
  "5분 전 옥상 평수 기준 예상 시공비 조회 완료!"
];
